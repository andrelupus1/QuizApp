...
class Usuarios extends CI_Controller{
    ...
    public function addUsuario(){
        ...
        if($dataJsonDecode == null){
            ...
            //Consulta se o email está cadastrado.
                $email = $dados['emailUsuario'];
                if($this->usuarios->getEmail($email)){//se cadastrado retorna erro
                    echo '{ "dados": { "status_cadastro": "0" }}';    
                }else{//se não, adiciona novo usuário
    ...
    public function recuperaSenha(){
        ...
        if($dataJsonDecode == null){
            ...
            //Consulta se o email está cadastrado.
                $email = $dados['emailUsuario'];
                if($this->usuarios->getEmail($email)){//se cadastrado envia senha
                    $resultado = array(
    ...
    public function reseta($resultado){
            ...
            if(count($resultado)>0){
                $this->usuarios->resetar($resultado); 
        }
    }
}