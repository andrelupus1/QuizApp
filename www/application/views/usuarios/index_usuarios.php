...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Usuários
            <small>Usuários administradores cadastrados no sistema</small>
        </h1>
        <ol class="breadcrumb">
                        ...
                        <tbody>
                            <?php foreach ($admin as $ad) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo anchor('/usuarios/editar/' . $ad->idusuarios, '<i class="glyphicon glyphicon-edit"></i>', 'class="btn btn-info"') . "&nbsp;";
                                        echo anchor('/usuarios/excluir/' . $ad->idusuarios, '<i class="glyphicon glyphicon-trash"></i>', 'class="btn btn-danger" onclick="return confirm("Confirma exclusão do Administrador?")"');
                                        ?>
                                    </td>
                                </tr>
                            <?php } ?>
