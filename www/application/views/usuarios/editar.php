...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Usuários
            <small>Usuários administradores cadastrados no site</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php
                              ...
                              echo form_open('/usuarios/editar/'.$admin->idusuarios);
                              echo '<span class="validacao"> '.  validation_errors().' </span>';
                              echo form_fieldset();

                              echo '<div class="form-group">';
                              echo '<label>Nome Administrador</label>';
                              ...
                              echo "<br /><br />";
                              echo form_hidden("administrador", $admin->idusuarios);
                              echo anchor('/usuarios', 'Voltar', 'class="label label-default"')."&nbsp;";
