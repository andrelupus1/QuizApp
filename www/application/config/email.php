...
$config['smtp_host']        = 'smtp.gmail.com';//'br748.hostgator.com.br';
...
$config['smtp_user']        = 'seuemail@gmail.com';//'naoresponda@oftquiz.com.br';
$config['smtp_pass']        = 'suasenhaaqui';
$config['smtp_port']        = 465;
$config['smtp_timeout']     = 30;                       // (in seconds)
$config['smtp_crypto']      = 'ssl';                    // '' or 'tls' or 'ssl'
$config['smtp_debug']       = 0; //0 por padrão         // PHPMailer's SMTP debug info level: 0 = off, 1 = commands, 2 = commands and data, 3 = as 2 plus connection status, 4 = low level data output.
...
$config['charset']          = 'UTF-8'; //null           // 'UTF-8', 'ISO-8859-15', ...; NULL (preferable) means config_item('charset'), i.e. the character set of the site.
